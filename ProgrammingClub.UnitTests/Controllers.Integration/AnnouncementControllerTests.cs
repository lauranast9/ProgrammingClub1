...
namespace ProgrammingClub.UnitTests.Controllers.Integration
{
    ...
    {
        private readonly AnnouncementsService _announcementService;
        private readonly AnnouncementsRepository _repository;
        private readonly AnnouncementsController _announcementController;
        ...
        public AnnouncementControllerTests()
        {
            ...
            _announcementService = new AnnouncementsService(_repository, null);
            _announcementController = new AnnouncementsController(_announcementService);
        }
